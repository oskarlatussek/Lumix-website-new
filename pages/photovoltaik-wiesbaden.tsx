        ...
        <div className="flex flex-col items-center max-w-full">
          ...
          >
            ...
            <div className="p-5 sm:p-10 flex flex-col items-center relative space-y-5 sm:space-y-10 py-10 mt-20 text-center">
              ...
              <p className="text-sm sm:text-lg lg:text-lg xl:text-lg leading-tight sm:leading-tight lg:leading-tight xl:leading-tight text-gray-300 font-medium max-w-4xl z-10 mb-44  sm:pb-0 pb-20 animate__animated animate__fadeIn animate__delay-3s">
                Photovoltaik bietet Ihnen die Möglichkeit, sich in Wiesbaden
                unabhängig von öffentlichen Stromanbietern zu machen und den
                Strom für Ihren Haushalt oder Ihren Betrieb ganz einfach auf dem
                Dach selbst zu produzieren.
              </p>
          ...
          <div className="items-center w-full justify-center pt-10 p-2 sm:p-5">
            ...
            <p className="text-xl text-xl w-full leading-tight sm:leading-tight lg:leading-tight font-medium max-w-[100%] p-5 sm:p-10 text-center lg:text-center">
              Sie möchten zum Klimaschutz beitragen und gleichzeitig Ihre
              Energiekosten senken? Der Umstieg auf regenerative Energien wird
              dank moderner Photovoltaik-Anlagen für Privathaushalte und
              Gewerbebetriebe in Wiesbaden immer attraktiver. Fortschreitende
              Technik auf dem Gebiet der Stromspeicher und bessere Wirkungsgrade
              führen dazu, dass Photovoltaik-Anlagen immer beliebter werden. Das
              Team von Lumix Solar ist im Raum Wiesbaden Ihr ansprechpartner für
              innovative Lösungen im Bereich Solartechnik. Lassen Sie sich von
              uns qualifiziert beraten.
            </p>
