        ...
        <div className="flex flex-col items-center max-w-full">
          ...
          >
            ...
            <div className="p-5 sm:p-10 flex flex-col items-center relative space-y-5 sm:space-y-10 py-10 mt-20 text-center">
              ...
              <p className="text-sm sm:text-lg lg:text-lg xl:text-lg leading-tight sm:leading-tight lg:leading-tight xl:leading-tight text-gray-300 font-medium max-w-4xl z-10 mb-44  sm:pb-0 pb-20 animate__animated animate__fadeIn animate__delay-3s">
                Mit einer modernen Photovoltaik-Anlage starten Sie in Mainz in
                Ihre persönliche Energiewende. Werden Sie unabhängig von teuren
                Stromanbietern und produzieren Sie den Strom für Ihren Haushalt
                ganz einfach selbst.
              </p>
          ...
          <div className="items-center w-full justify-center pt-10 p-2 sm:p-5">
            ...
            <p className="text-xl text-xl w-full leading-tight sm:leading-tight lg:leading-tight font-medium max-w-[100%] p-5 sm:p-10 text-center lg:text-center">
              Immer mehr Privathaushalte und Gewerbebetriebe entscheiden sich
              für eine innovative Photovoltaik-Anlage in Mainz. Insbesondere die
              Tatsache, dass sich der Wirkungsgrad von Photovoltaik-Anlagen
              stark erhöht hat und dadurch die Wirtschaftlichkeit enorm
              verbessert wurde, trägt zur steigenden Attraktivität von
              PV-Anlagen bei. Dank einer durchschnittlichen Amortisationsdauer
              der Photovoltaik-Anlage von unter zehn Jahren und einer
              Lebensdauer von mehr als 25 Jahren kann die Frage: Lohnt sich PV?,
              mittlerweile mit einem eindeutigen „Ja“ beantwortet werden. Gerne
              unterbreiten wir Ihnen für den Raum Mainz ein individuelles
              Angebot.
            </p>
