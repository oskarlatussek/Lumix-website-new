                            ...
                            <div className={`image-section-left mt-10 -mb-20`}>
                                ...
                                <div className='flex flex-col space-y-5 max-w-3xl self-center'>
                                    ...
                                    <p className='text-justify'>
                                        ...
                                        Durch die enge Vernetzung mit sowohl Fachhändlern als auch Monteuren, garantieren wir Ihnen eine <b>zeitnahe Realisierung Ihres Projekts</b>. So konnten wir bereits über 250 Projekte in der Region erfolgreich umsetzen.
                                    </p>
                                </div>
                            </div>
