        ...
        <div className="flex flex-col items-center max-w-full">
          ...
          >
            ...
            <div className="p-5 sm:p-10 flex flex-col items-center relative space-y-5 sm:space-y-10 py-10 mt-20 text-center">
              ...
              <p className="text-sm sm:text-lg lg:text-lg xl:text-lg leading-tight sm:leading-tight lg:leading-tight xl:leading-tight text-gray-300 font-medium max-w-4xl z-10 mb-44  sm:pb-0 pb-20 animate__animated animate__fadeIn animate__delay-3s">
                Wenn Sie eine Solaranlage von Lumix Solar installieren lassen,
                produzieren Sie in Worms Ihren eigenen Strom – klimaneutral aus
                sauberer Sonnenenergie. Gleichzeitig machen Sie sich unabhängig
                von Stromkonzernen, Stromausfällen und ständig steigenden
                Stromrechnungen.
              </p>
          ...
          <div className="items-center w-full justify-center pt-10 p-2 sm:p-5">
            ...
            <p className="text-xl text-xl w-full leading-tight sm:leading-tight lg:leading-tight font-medium max-w-[100%] p-5 sm:p-10 text-center lg:text-center">
              Sie möchten unabhängig von den großen Stromkonzernen werden, die
              Ihre Strompreise teilweise willkürlich erhöhen? Sie fürchten
              Blackouts aufgrund wachsender Überlastung der öffentlichen
              Stromnetze? Sie wollen aktiv zum Klimaschutz beitragen, anstatt zu
              warten, dass endlich politische Entscheidungen getroffen werden?
              Das sind gute Gründe, um eine Solaranlage in Worms installieren zu
              lassen und künftig den Strombedarf mit klimaneutralem Sonnenstrom
              zu decken. Wenn Sie erwägen, eine PV-Anlage zu kaufen, sind Sie
              bei Lumix Solar genau richtig, denn wir bieten unseren Kunden
              einen ausgezeichneten ganzheitlichen Service.
            </p>
