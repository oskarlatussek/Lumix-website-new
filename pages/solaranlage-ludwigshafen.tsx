        ...
        <div className="flex flex-col items-center max-w-full">
          ...
          >
            ...
            <div className="p-5 sm:p-10 flex flex-col items-center relative space-y-5 sm:space-y-10 py-10 mt-20 text-center">
              ...
              >
                Solaranlage – klimaneutraler Strom in Ludwigshafen
              </h3>
              <p className="text-sm sm:text-lg lg:text-lg xl:text-lg leading-tight sm:leading-tight lg:leading-tight xl:leading-tight text-gray-300 font-medium max-w-4xl z-10 mb-44  sm:pb-0 pb-20 animate__animated animate__fadeIn animate__delay-3s">
                Mit den innovativen Solaranlagen aus dem Hause Lumix Solar
                machen Sie sich in Ludwigshafen unabhängig von
                Strompreiserhöhungen und tragen aktiv zum Klimaschutz bei.
                Infomieren Sie sich über die Optionen moderner PV-Anlagen für
                die Stromerzeugung.
              </p>
          ...
          <div className="items-center w-full justify-center pt-10 p-2 sm:p-5">
            ...
            <p className="text-xl text-xl w-full leading-tight sm:leading-tight lg:leading-tight font-medium max-w-[100%] p-5 sm:p-10 text-center lg:text-center">
              Mit einer leistungsstarken Solaranlage von Lumix Solar werden Sie
              in Ludwigshafen endlich unabhängig von den Stromversorgern und
              produzieren Ihren eigenen Strom. Dadurch schützen Sie sich optimal
              vor den gefürchteten Blackouts, die aufgrund einer zunehmenden
              Überlastung der öffentlichen Stromnetze immer wahrscheinlicher
              werden. Außerdem ist es aus Gründen des Klimaschutzes sinnvoll,
              eine Solaranlage zu kaufen, denn dadurch tragen Sie in
              Ludwigshafen aktiv dazu bei, dass die Energiewende gelingt. Als
              renommierter regionaler Anbieter konfigurieren wir
              maßgeschneiderte PV-Anlagen.
            </p>
