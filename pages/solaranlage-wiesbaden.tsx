        ...
        <div className="flex flex-col items-center max-w-full">
          ...
          >
            ...
            <div className="p-5 sm:p-10 flex flex-col items-center relative space-y-5 sm:space-y-10 py-10 mt-20 text-center">
              ...
              <p className="text-sm sm:text-lg lg:text-lg xl:text-lg leading-tight sm:leading-tight lg:leading-tight xl:leading-tight text-gray-300 font-medium max-w-4xl z-10 mb-44  sm:pb-0 pb-20 animate__animated animate__fadeIn animate__delay-3s">
                Mit einer Solaranlage werden Sie in Wiesbaden zum Produzenten
                Ihres eigenen Stroms. Nutzen Sie die Vorteile innovativer
                Solartechnik, um Stromkosten langfristig zu minimieren und einen
          ...
          <div className="items-center w-full justify-center pt-10 p-2 sm:p-5">
            ...
            <p className="text-xl text-xl w-full leading-tight sm:leading-tight lg:leading-tight font-medium max-w-[100%] p-5 sm:p-10 text-center lg:text-center">
              Dank moderner Photovoltaik-Technologie ist es ganz einfach, sich
              von Stromkonzernen unabhängig zu machen. Investieren Sie deshalb
              in eine Solaranlage aus dem Hause Lumix Solar und profitieren Sie
              in Wiesbaden von den Vorteilen: Sie reduzieren dauerhaft Ihre
              Stromkosten, müssen sich keine Gedanken über ständig steigende
              Strompreise machen, sind vor Stromausfällen aufgrund überlasteter
              Stromnetze geschützt und tragen mit der Solaranlage in Wiesbaden
              außerdem zum Gelingen der Energiewende bei.
            </p>
