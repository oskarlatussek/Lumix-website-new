        ...
        <div className="flex flex-col items-center max-w-full">
          ...
          >
            ...
            <div className="p-5 sm:p-10 flex flex-col items-center relative space-y-5 sm:space-y-10 py-10 mt-20 text-center">
              ...
              >
                Solaranlage zur Stromerzeugung in Darmstadt
              </h3>
              <p className="text-sm sm:text-lg lg:text-lg xl:text-lg leading-tight sm:leading-tight lg:leading-tight xl:leading-tight text-gray-300 font-medium max-w-4xl z-10 mb-44  sm:pb-0 pb-20 animate__animated animate__fadeIn animate__delay-3s">
                Die Solaranlagen von Lumix Solar bieten Ihnen die Möglichkeit,
                in Darmstadt klimaneutral Strom auf dem eigenen Dach zu
                erzeugen, sich damit unabhängig von den Preissteigerungen der
                Versorgungsunternehmen zu machen und gleichzeitig zum
          ...
          <div className="items-center w-full justify-center pt-10 p-2 sm:p-5">
            ...
            <p className="text-xl text-xl w-full leading-tight sm:leading-tight lg:leading-tight font-medium max-w-[100%] p-5 sm:p-10 text-center lg:text-center">
              Die innovativen Solaranlagen aus dem Haus Lumix Solar machen Sie
              in Darmstadt unabhängig von ständig steigenden Strompreisen der
              Versorgungsunternehmen und helfen Ihnen dabei, Ihre Energiekosten
              langfristig drastisch zu reduzieren. Ein weiterer Vorteil dieser
              Unabhängigkeit betrifft den Schutz vor Blackouts aufgrund immer
              stärker belasteter Stromnetze – wenn Sie eine Solaranlage kaufen,
              brauchen Sie sich darüber in Darmstadt keine Sorgen mehr zu
              machen, denn Sie decken Ihren Strombedarf zum größten Teil mit dem
              selbst produzierten Sonnenstrom ab. Neben dieser Sicherheit bietet
              eine Solaranlage mit integriertem Speicher Vorteile für den
              Klimaschutz. Sie tragen aktiv dazu bei, dass die Energiewende in
              Darmstadt erfolgreich umgesetzt wird.
            </p>
