        ...
        <div className="flex flex-col items-center max-w-full">
          ...
          >
            ...
            <div className="p-5 sm:p-10 flex flex-col items-center relative space-y-5 sm:space-y-10 py-10 mt-20 text-center">
              ...
              <p className="text-sm sm:text-lg lg:text-lg xl:text-lg leading-tight sm:leading-tight lg:leading-tight xl:leading-tight text-gray-300 font-medium max-w-4xl z-10 mb-44  sm:pb-0 pb-20 animate__animated animate__fadeIn animate__delay-3s">
                Mit einer Solaranlage von Lumix Solar produzieren Sie Ihren
                Strom in Mainz auf dem eigenen Dach oder an der Fassade.
                Informieren Sie sich über die Möglichkeiten der modernen
                Solartechnik und reduzieren Sie dauerhaft Ihre Energiekosten.
              </p>
          ...
          <div className="items-center w-full justify-center pt-10 p-2 sm:p-5">
            ...
            <p className="text-xl text-xl w-full leading-tight sm:leading-tight lg:leading-tight font-medium max-w-[100%] p-5 sm:p-10 text-center lg:text-center">
              Mit den hochwertigen Solaranlagen von Lumix Solar werden Sie in
              Mainz endlich unabhängig von den Stromkonzernen und deren mehr
              oder weniger willkürlichen Strompreiserhöhungen. Wenn Sie sich
              dafür entscheiden, eine Solaranlage zu kaufen, generieren wir eine
              individuelle Lösung, die sich an Ihrem Verbrauch und den örtlichen
              Gegebenheiten in Mainz orientiert. Unsere Solarexperten werden
              beispielsweise die Dachneigung und -ausrichtung berücksichtigen
              und Ihnen bei der Konfiguration der Anlage eine geeignete
              Montageoption vorschlagen.
            </p>
