        ...
        <div className="flex flex-col items-center max-w-full">
          ...
          >
            ...
            <div className="p-5 sm:p-10 flex flex-col items-center relative space-y-5 sm:space-y-10 py-10 mt-20 text-center">
              ...
              >
                Photovoltaik in Ludwigshafen – aktiver Klimaschutz
              </h3>
              <p className="text-sm sm:text-lg lg:text-lg xl:text-lg leading-tight sm:leading-tight lg:leading-tight xl:leading-tight text-gray-300 font-medium max-w-4xl z-10 mb-44  sm:pb-0 pb-20 animate__animated animate__fadeIn animate__delay-3s">
                Mit einer modernen Photovoltaik-Anlage starten Sie in
                Ludwigshafen Ihre ganz persönliche Energiewende. Sparen Sie
                Stromkosten, schützen Sie sich vor Stromausfällen und beginnen
                Sie jetzt damit, klimaneutralen Strom selbst zu produzieren.{' '}
              </p>
          ...
          <div className="items-center w-full justify-center pt-10 p-2 sm:p-5">
            ...
            <p className="text-xl text-xl w-full leading-tight sm:leading-tight lg:leading-tight font-medium max-w-[100%] p-5 sm:p-10 text-center lg:text-center">
              Die Photovoltaik-Technologie, insbesondere die Entwicklung
              moderner Speicher, hat in den letzten Jahren erhebliche
              Fortschritte gemacht – Photovoltaik-Anlagen von Lumix Solar
              ermöglichen die Steigerung der Eigenverbrauchsquote von 30 auf
              maximal 80 Prozent, sodass sich die Effizienz der PV-Anlage in
              Ludwigshafen drastisch erhöht. Dank einer modernen
              Photovoltaik-Anlage mit Stromspeicher werden Sie fast vollständig
              unabhängig von den öffentlichen Stromanbietern und schützen sich
              zudem effektiv vor Stromausfällen aufgrund überlasteter
              Stromnetze.
            </p>
