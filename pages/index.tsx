    ...
    return (
        <>
            <div className="flex flex-col items-center max-w-full">
                <Hero image='/Images/title.jpg' title='Solaranlagen' text='Mannheim | Rhein-Neckar | Pfalz'/>
                <Process />
