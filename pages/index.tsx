    ...
    return (
        <>
            <div className="flex flex-col items-center max-w-full">
                <Hero image='/Fotos/DSCF6833.JPG' title='Solaranlagen' text='Mannheim | Rhein-Neckar | Pfalz'/>
                <Process />

                <Subpage title='Private Anlagen' text='Mit einer Photovoltaikanlage können Sie nicht nur den Wert Ihres Gebäudes steigern, sondern auch Ihren eigenen Strom produzieren und sich dadurch von steigenden Stromkosten unabhängig machen. Wir zeigen Ihnen welche Anlagenoptionen sich bei Ihnen rentieren und auf welche Faktoren Sie achten müssen.' image='/Fotos/DSCF6857.JPG' link="/photovoltaik" left />
