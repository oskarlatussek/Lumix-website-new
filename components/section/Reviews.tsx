    ...
    <div className="outerTestimonial  flex items-center w-full justify-center pb-20 px-2 sm:px-5">
      ...
      >
        <SwiperSlide className="p-6 testimonialSlide rounded-xl">
          ...
          <b>Positive: </b> Professionalism, Responsiveness, Value<br></br><br></br>
        ...
        <SwiperSlide className="p-6 testimonialSlide rounded-xl">
          ...
          <div className="testimonialText  my-3">
         <b>Positive:</b> Professionalism, Punctuality, Quality, Responsiveness, Value
        ...
        <SwiperSlide className="p-6 testimonialSlide rounded-xl">
          ...
          <div className="testimonialText  my-3">
          Hier wird in Arbeitsschutz investiert. PSAgA Training /
Unterweisung nach DGUV R 112-198 & -199.
Stay safe !
          </div>
        </SwiperSlide>
        <SwiperSlide className="p-6 testimonialSlide rounded-xl">
          ...
          <div className="testimonialText  my-3">
<b>Positive: </b>Professionalism, Punctuality, Quality, Responsiveness, Value<br></br><br></br>
...
Keine Kritikpunkte
        ...
        <SwiperSlide className="p-6 testimonialSlide rounded-xl">
          ...
          <div className="testimonialText  my-3">
            <b>Positive: </b>Professionalism, Punctuality, Responsiveness<br></br>
            <br></br>
        ...
        <SwiperSlide className="p-6 testimonialSlide rounded-xl">
          ...
          <div className="testimonialText  my-3">
            <b>Positive: </b>Professionalism, Punctuality, Quality, Responsiveness, Value<br></br>
            <br></br>
