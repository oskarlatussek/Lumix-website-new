                ...
                <div className="flex flex-col items-center space-y-10 sm:space-y-16 max-w-full lg:max-w-[50%]">
                    ...
                    <div className="flex flex-col sm:flex-row space-x-0 sm:space-x-10 space-y-3 sm:space-y-0 w-max">
                        <div className="flex items-center space-x-3 text-xl">
                            ...
                            <a href="mailto:info@lumix.solar" className="text-gray-300 hover:text-black transition duration-200 ease-linear">info@lumix.solar</a>
                        </div>
                        <div className="flex items-center space-x-3 text-xl">
                            ...
                            <a href="tel:+49621150350" className="text-gray-300 hover:text-black transition duration-200 ease-linear">+49 621 150 350</a>
                        </div>
												<div className="flex items-center space-x-3 text-xl">
														<FaMapPin className="text-yellow-400 text-3xl" />
                            {/* <a href="tel:+491627656187" className="text-gray-600 hover:text-black transition duration-200 ease-linear">+49 162 7656 187</a> */}
                            <span className="text-gray-300 hover:text-black transition duration-200 ease-linear">Strasse 1, 12345 Stadt</span>
                        </div>
                    </div>
