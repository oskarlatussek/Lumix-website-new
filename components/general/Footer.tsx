...
*/}
        <footer style={{ top: 0 }} id="contact" className="bg-white backdrop-blur-s 2xl:p-20 flex relative flex-col-reverse justify-between items-center space-x-0">
           <div style={{ top: 0 }} className="absolute w-full h-full z-0 bg-white backdrop-blur-s animate__animated animate__fadeIn animate__delay-1s" />
				
					 <div className="w-full flex flex-col pb-16 relative ">

						<Contact />
						<div className="p-5 sm:p-5 sm:pt-16 flex flex-col md:flex-row gap-x-12 justify-start">
            ...
            {/*<div className="flex flex-col-reverse sm:flex-row space-x-0 sm:space-x-14 w-full xl:w-1/2 h-full justify-center items-start sm:items-center">
                <div className="flex flex-col space-y-3 items-start sm:items-end w-">
                    ...
                    <div className="flex items-center space-x-3 text-xl">
                        ...
                        <a href="mailto:info@lumix.solar" className="text-gray-600 hover:text-yellow-400 transition duration-200 ease-linear">info@lumix.solar</a>
                    </div>
                    <div className="flex items-center space-x-3 text-xl">
                        <FiPhone className="text-yellow-400 text-3xl" />
                         <a href="tel:+491627656187" className="text-gray-600 hover:text-yellow-400 transition duration-200 ease-linear">+49 162 7656 187</a> 
                        <a href="tel:+49621150350" className="text-gray-600 hover:text-yellow-400 transition duration-200 ease-linear">+49 621 150 350</a>
