...
const Footer = () => {
    ...
    return (
        <footer id="contact" className="bg-black/50 backdrop-blur-s p-5 sm:p-10 2xl:p-20 xl:pb-24 flex relative flex-col-reverse xl:flex-row justify-between items-center space-x-0 xl:space-x-10">
