const Vision = () => {
    ...
    return (
        <>
            <div className="h-screen mb-20 lg:-mb-10 flex flex-col-reverse lg:flex-row items-center lg:items-stretch">
            ...
            <div className="h-screen mt-0 lg:-mt-10 flex flex-col lg:flex-row items-center lg:items-stretch">
